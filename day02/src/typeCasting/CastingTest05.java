...
public class CastingTest05 {
	public static void main(String[] args) {
		...
		// boolean bNum = 10;  boolean 타입의 저장공간에 정수형 값 저장 불가능
		// System.out.println(bNum);
		
		// 정수형 long
		long lNum2 = 10L;
		//int 타입의 저장공간에 long 타입의 값을 넣을 때는 강제형변환만 가능 
		int iNum2 = (int)10L;
		double dNum2 = 10L; // 자동형변환 가능
		float fNum2 = 10L; // 자동형변환 가능
		//char 타입의 저장공간에 long 타입의 값을 넣을 때는 강제형변환만 가능 
		char cNum2 = (char)65L;
		...
		int iNum3 = (int)10.5; // 강제형변환
		System.out.println(iNum3);
		long lNum3 = (long)10.5; // 정수형의 저장공간에 실수형 값을 저장 시 강제형변환
		System.out.println(lNum3);
		float fNum3 = (float)10.5; // float 저장공간에 double 값을 저장 시 강제형변환
		...
		// boolean bNum4 = (boolean)10.5f;
		
		// 문자형 char
		char cNum5 = 'b';
		System.out.println((int)cNum5); // 강제형변환(문자형 -> 정수형)
		int iNum5 = (int)'b'; // int 타입으로 변환 시 강제형변환
		long lNum5 = 'b'; // long 타입으로 변환 시 자동형변환
